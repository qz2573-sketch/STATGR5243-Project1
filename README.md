...
Stratified Sampling: Downloads large Parquet files for July, August, September, and October 2025, and extracts a random sample of 200 records per vehicle type (Yellow, Green, FHV) to ensure a manageable dataset size for analysis.
...
Scope: 2025 Data (Months 7-10) for Yellow Taxi, Green Taxi, and For-Hire Vehicles.
